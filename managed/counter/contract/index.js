...
export class Contract {
  ...
  constructor(...args_0) {
    ...
    if (typeof(witnesses_0.voteToken) !== 'function') {
      throw new __compactRuntime.CompactError('first (witnesses) argument to Contract constructor does not contain a function-valued field named voteToken');
    }
  ...
  _voteToken_0(context, partialProofData) {
    const witnessContext_0 = __compactRuntime.createWitnessContext(ledger(context.currentQueryContext.state), context.currentPrivateState, context.currentQueryContext.address);
    const [nextPrivateState_0, result_0] = this.witnesses.voteToken(witnessContext_0);
    context.currentPrivateState = nextPrivateState_0;
    if (!(typeof(result_0) === 'bigint' && result_0 >= 0n && result_0 <= 18446744073709551615n)) {
      __compactRuntime.typeError('voteToken',
                                 'return value',
  ...
  _castVote_0(context, partialProofData) {
    const token_0 = this._voteToken_0(context, partialProofData);
    __compactRuntime.assert(token_0 > 0n, 'Invalid vote token');
    const tmp_0 = 1n;
    __compactRuntime.queryLedgerState(context,
                                      partialProofData,
                                      [
...
const _dummyContract = new Contract({ voteToken: (...args) => undefined });
