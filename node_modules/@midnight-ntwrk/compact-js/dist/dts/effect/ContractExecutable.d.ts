...
import { LedgerParameters, MaintenanceUpdate, type Transcript } from '@midnight-ntwrk/ledger-v8';
...
export interface ContractExecutable<in out C extends Contract.Contract<PS>, PS, out E = never, out R = never> extends Pipeable {
     ...
     */
    circuit<K extends Contract.ProvableCircuitId<C> = Contract.ProvableCircuitId<C>>(provableCircuitId: K, circuitContext: ContractExecutable.CircuitContext<PS>, ...args: Contract.Contract.CircuitParameters<C, K>): Effect.Effect<ContractExecutable.CallResult<C, PS, K>, E, R>;
    /**
     ...
     * @returns A {@link ContractExecutable.MaintenanceResult} describing the result of the maintenance update.
     */
    removeContractOperation<K extends Contract.ProvableCircuitId<C> = Contract.ProvableCircuitId<C>>(provableCircuitId: K, contractContext: ContractExecutable.ContractContext): Effect.Effect<ContractExecutable.MaintenanceResult, E, R>;
    /**
     ...
     * @returns A {@link ContractExecutable.MaintenanceResult} describing the result of the maintenance update.
     */
    addOrReplaceContractOperation<K extends Contract.ProvableCircuitId<C> = Contract.ProvableCircuitId<C>>(provableCircuitId: K, verifierKey: Contract.VerifierKey, contractContext: ContractExecutable.ContractContext): Effect.Effect<ContractExecutable.MaintenanceResult, E, R>;
}
export declare namespace ContractExecutable {
    ...
    type CallResultPrivate<C extends Contract.Contract<PS>, PS, K extends Contract.ProvableCircuitId<C>> = {
    ...
    type CallResult<C extends Contract.Contract<PS>, PS, K extends Contract.ProvableCircuitId<C>> = {
