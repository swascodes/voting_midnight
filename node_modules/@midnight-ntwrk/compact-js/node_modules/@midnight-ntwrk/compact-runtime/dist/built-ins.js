...
import { CompactTypeJubjubPoint } from './compact-types.js';
...
export function jubjubPointX(pt) {
    return pt.x;
}
export function jubjubPointY(pt) {
    return pt.y;
}
export function constructJubjubPoint(x, y) {
    return { x: x, y: y };
}
/**
