 ...
 */
export type ContractConstructorOptionsWithArguments<C extends Contract.Any> = Contract.InitializeParameters<C> extends [] ? ContractConstructorOptionsBase<C> : ContractConstructorOptionsBase<C> & {
    /**
 ...
 */
export type ContractConstructorOptionsWithProviderDataDependencies<C extends Contract.Any> = ContractConstructorOptionsWithArguments<C> & ContractConstructorOptionsProviderDataDependencies;
/**
 * Conditional type that optionally adds the inferred circuit argument types to
 * the target of a circuit invocation.
 */
export type ContractConstructorOptionsWithPrivateState<C extends Contract.Any> = ContractConstructorOptionsWithProviderDataDependencies<C> & {
    /**
 ...
 * the target of a circuit invocation.
 */
export type ContractConstructorOptions<C extends Contract.Any> = ContractConstructorOptionsWithProviderDataDependencies<C> | ContractConstructorOptionsWithPrivateState<C>;
/**
