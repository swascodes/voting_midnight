 ...
 */
export type DeployContractOptions<C extends Contract.Any> = DeployContractOptionsBase<C> | DeployContractOptionsWithPrivateState<C>;
/**
...
export declare function deployContract<C extends Contract<undefined>>(providers: ContractProviders<C, Contract.ProvableCircuitId<C>, unknown>, options: DeployContractOptionsBase<C>): Promise<DeployedContract<C>>;
export declare function deployContract<C extends Contract.Any>(providers: ContractProviders<C>, options: DeployContractOptionsWithPrivateState<C>): Promise<DeployedContract<C>>;
