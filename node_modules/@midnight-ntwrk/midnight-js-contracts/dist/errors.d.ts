...
export declare const isEffectContractError: (error: unknown) => error is EffectContractError;
/**
 ...
 */
export declare class ScopedTransactionIdentityMismatchError extends Error {
    readonly cached: {
