...
import { type AnyProvableCircuitId, type PrivateStateId, type VerifierKey } from '@midnight-ntwrk/midnight-js-types';
 ...
 */
export declare const verifyContractState: (verifierKeys: [AnyProvableCircuitId, VerifierKey][], contractState: ContractState) => void;
/**
 ...
 * private state ID.
 */
export type FindDeployedContractOptionsStorePrivateState<C extends Contract.Any> = FindDeployedContractOptionsExistingPrivateState<C> & {
    /**
 ...
 */
export type FindDeployedContractOptions<C extends Contract.Any> = FindDeployedContractOptionsBase<C> | FindDeployedContractOptionsExistingPrivateState<C> | FindDeployedContractOptionsStorePrivateState<C>;
/**
...
export declare function findDeployedContract<C extends Contract<undefined>>(providers: ContractProviders<C, Contract.ProvableCircuitId<C>, unknown>, options: FindDeployedContractOptionsBase<C>): Promise<FoundContract<C>>;
export declare function findDeployedContract<C extends Contract.Any>(providers: ContractProviders<C>, options: FindDeployedContractOptionsExistingPrivateState<C>): Promise<FoundContract<C>>;
export declare function findDeployedContract<C extends Contract.Any>(providers: ContractProviders<C>, options: FindDeployedContractOptionsStorePrivateState<C>): Promise<FoundContract<C>>;
