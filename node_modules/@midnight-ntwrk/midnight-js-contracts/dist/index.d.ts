...
import { CoinPublicKey, ContractAddress, ContractState, StateValue, Op, AlignedValue, ZswapLocalState, SigningKey } from '@midnight-ntwrk/compact-runtime';
import { EncPublicKey, ZswapChainState, LedgerParameters, PartitionedTranscript, ContractAddress as ContractAddress$1, UnprovenTransaction, ShieldedCoinInfo, CoinPublicKey as CoinPublicKey$1, SigningKey as SigningKey$1 } from '@midnight-ntwrk/ledger-v8';
import { MidnightProviders, PrivateStateId, PublicDataProvider, PrivateStateProvider, AnyProvableCircuitId, FinalizedTxData, ZKConfigProvider, VerifierKey, UnshieldedBalances } from '@midnight-ntwrk/midnight-js-types';

/**
 * Describes the target of a circuit invocation.
 */
type CallOptionsBase<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>> = {
    /**
 ...
 */
type CallOptionsWithArguments<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>> = Contract.CircuitParameters<C, PCK> extends [] ? CallOptionsBase<C, PCK> : CallOptionsBase<C, PCK> & {
    /**
 ...
 */
type CallOptionsWithProviderDataDependencies<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>> = CallOptionsWithArguments<C, PCK> & CallOptionsProviderDataDependencies;
/**
 * Call options for contracts with private state.
 */
type CallOptionsWithPrivateState<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>> = CallOptionsWithProviderDataDependencies<C, PCK> & {
    /**
 ...
 */
type CallOptions<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>> = CallOptionsWithProviderDataDependencies<C, PCK> | CallOptionsWithPrivateState<C, PCK>;
/**
 * The private (sensitive) portions of the call result.
 */
type CallResultPrivate<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>> = {
    /**
 ...
 */
type CallResult<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>> = {
    /**
 ...
 * a given contract.
 */
type ContractProviders<C extends Contract.Any = Contract.Any, PCK extends Contract.ProvableCircuitId<C> = Contract.ProvableCircuitId<C>, PS = Contract.PrivateState<C>> = MidnightProviders<PCK, PrivateStateId, PS>;
 ...
 */
type SubmitTxOptions<PCK extends AnyProvableCircuitId> = {
    /**
 ...
 */
type SubmitTxProviders<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>> = Omit<ContractProviders<C, PCK>, 'privateStateProvider'>;
/**
 ...
 */
declare const submitTx: <C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>>(providers: SubmitTxProviders<C, PCK>, options: SubmitTxOptions<PCK>) => Promise<FinalizedTxData>;
/**
 * Proves, balances, and submits an unproven deployment or call transaction using
 ...
 */
declare const submitTxAsync: <C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>>(providers: SubmitTxProviders<C, PCK>, options: SubmitTxOptions<PCK>) => Promise<string>;
 ...
 */
type UnsubmittedCallTxData<C extends Contract$1.Any, PCK extends Contract$1.ProvableCircuitId<C>> = CallResult<C, PCK> & {
    /**
 ...
 */
type FinalizedCallTxData<C extends Contract$1.Any, PCK extends Contract$1.ProvableCircuitId<C>> = UnsubmittedCallTxData<C, PCK> & {
    /**
 ...
 */
type SubmittedCallTx<C extends Contract$1.Any, PCK extends Contract$1.ProvableCircuitId<C>> = {
    /**
...
/** @internal */
declare const GetCurrentStatesForIdentity: unique symbol;
 ...
 */
interface TransactionContext<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C> = Contract.ProvableCircuitId<C>> {
    readonly [TypeId]: TypeId;
    readonly [Submit]: () => Promise<FinalizedCallTxData<C, PCK>>;
    readonly [MergeUnsubmittedCallTxData]: (circuitId: PCK, callData: UnsubmittedCallTxData<C, PCK>, privateStateId?: PrivateStateId) => void;
    readonly [CacheStates]: (states: ContractStates<Contract.PrivateState<C>> | PublicContractStates, identity: CachedStateIdentity) => void;
    readonly [GetCurrentStatesForIdentity]: (identity: CachedStateIdentity) => ContractStates<Contract.PrivateState<C>> | PublicContractStates | undefined;
    /**
     ...
     */
    getAdditionalMappings(): ReadonlyMap<CoinPublicKey$1, EncPublicKey> | undefined;
    /**
...
type ScopedTransactionOptions = {
     ...
     * keys for coins created during circuit execution.
     */
    readonly additionalCoinEncPublicKeyMappings?: ReadonlyMap<CoinPublicKey$1, EncPublicKey>;
};
/**
 ...
 */
declare const withContractScopedTransaction: <C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C> = Contract.ProvableCircuitId<C>>(providers: ContractProviders<C, PCK>, fn: (txCtx: TransactionContext<C, PCK>) => Promise<void>, options?: ScopedTransactionOptions) => Promise<FinalizedCallTxData<C, PCK>>;

declare function createUnprovenCallTxFromInitialStates<C extends Contract<undefined>, PCK extends Contract.ProvableCircuitId<C>>(zkConfigProvider: ZKConfigProvider<string>, options: CallOptionsWithProviderDataDependencies<C, PCK>, walletEncryptionPublicKey: EncPublicKey): Promise<UnsubmittedCallTxData<C, PCK>>;
declare function createUnprovenCallTxFromInitialStates<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>>(zkConfigProvider: ZKConfigProvider<string>, options: CallOptionsWithPrivateState<C, PCK>, walletEncryptionPublicKey: EncPublicKey): Promise<UnsubmittedCallTxData<C, PCK>>;
/**
 * Base type for configuration for a call transaction; identical to {@link CallOptionsWithArguments}.
 */
type CallTxOptionsBase<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>> = CallOptionsWithArguments<C, PCK>;
/**
 ...
 */
type CallTxOptionsWithPrivateStateId<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>> = CallTxOptionsBase<C, PCK> & {
    /**
 ...
 */
type CallTxOptions<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>> = CallTxOptionsBase<C, PCK> | CallTxOptionsWithPrivateStateId<C, PCK>;
/**
...
declare function createUnprovenCallTx<C extends Contract<undefined>, PCK extends Contract.ProvableCircuitId<C>>(providers: UnprovenCallTxProvidersBase, options: CallTxOptionsBase<C, PCK>, transactionContext?: TransactionContext<C, PCK>): Promise<UnsubmittedCallTxData<C, PCK>>;
declare function createUnprovenCallTx<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>>(providers: UnprovenCallTxProvidersWithPrivateState<C>, options: CallTxOptionsWithPrivateStateId<C, PCK>, transactionContext?: TransactionContext<C, PCK>): Promise<UnsubmittedCallTxData<C, PCK>>;
...
type CircuitCallTxInterface<C extends Contract.Any> = {
    [PCK in Contract.ProvableCircuitId<C>]: {
        ...
        (txCtx: TransactionContext<C, PCK>, ...args: Contract.CircuitParameters<C, PCK>): Promise<CallResult<C, PCK>>;
    };
};
/**
 * Creates a {@link CallTxOptions} object from various data.
 */
declare const createCallTxOptions: <C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>>(compiledContract: CompiledContract.CompiledContract<C, any>, // eslint-disable-line @typescript-eslint/no-explicit-any
circuitId: PCK, contractAddress: ContractAddress$1, privateStateId: PrivateStateId | undefined, additionalCoinEncPublicKeyMappings: ReadonlyMap<CoinPublicKey$1, EncPublicKey> | undefined, args: Contract.CircuitParameters<C, PCK>) => CallTxOptions<C, PCK>;
/**
 ...
 */
declare const createCircuitMaintenanceTxInterface: <C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>>(providers: ContractProviders<C, PCK>, circuitId: PCK, compiledContract: CompiledContract.CompiledContract<C, any>, // eslint-disable-line @typescript-eslint/no-explicit-any
 ...
 */
type CircuitMaintenanceTxInterfaces<C extends Contract.Any> = Record<Contract.ProvableCircuitId<C>, CircuitMaintenanceTxInterface>;
/**
 ...
 */
declare const verifyContractState: (verifierKeys: [AnyProvableCircuitId, VerifierKey][], contractState: ContractState) => void;
/**
...
declare function findDeployedContract<C extends Contract$1<undefined>>(providers: ContractProviders<C, Contract$1.ProvableCircuitId<C>, unknown>, options: FindDeployedContractOptionsBase<C>): Promise<FoundContract<C>>;
...
declare function deployContract<C extends Contract<undefined>>(providers: ContractProviders<C, Contract.ProvableCircuitId<C>, unknown>, options: DeployContractOptionsBase<C>): Promise<DeployedContract<C>>;
...
declare class TxFailedError extends Error {
    ...
    readonly circuitId?: (AnyProvableCircuitId | AnyProvableCircuitId[]) | undefined;
    /**
     ...
     *                  failed.
     */
    constructor(finalizedTxData: FinalizedTxData, circuitId?: (AnyProvableCircuitId | AnyProvableCircuitId[]) | undefined);
}
/**
...
declare class CallTxFailedError extends TxFailedError {
     ...
     */
    constructor(finalizedTxData: FinalizedTxData, circuitId: AnyProvableCircuitId | AnyProvableCircuitId[]);
}
/**
...
declare class ContractTypeError extends TypeError {
     ...
     */
    constructor(contractState: ContractState, circuitIds: AnyProvableCircuitId[]);
}
/**
...
type SubmitCallTxProviders<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>> = ContractProviders<C> | SubmitTxProviders<C, PCK>;
declare function submitCallTx<C extends Contract<undefined>, PCK extends Contract.ProvableCircuitId<C>>(providers: SubmitTxProviders<C, PCK>, options: CallTxOptionsBase<C, PCK>): Promise<FinalizedCallTxData<C, PCK>>;
declare function submitCallTx<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>>(providers: ContractProviders<C>, options: CallTxOptionsWithPrivateStateId<C, PCK>): Promise<FinalizedCallTxData<C, PCK>>;
declare function submitCallTx<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>>(providers: ContractProviders<C>, options: CallTxOptionsWithPrivateStateId<C, PCK>, transactionContext: TransactionContext<C, PCK>): Promise<CallResult<C, PCK>>;
declare function submitCallTx<C extends Contract<undefined>, PCK extends Contract.ProvableCircuitId<C>>(providers: SubmitTxProviders<C, PCK>, options: CallTxOptionsBase<C, PCK>, transactionContext: TransactionContext<C, PCK>): Promise<CallResult<C, PCK>>;
/**
 ...
 * ```
 */
declare function submitCallTxAsync<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>>(providers: SubmitCallTxProviders<C, PCK>, options: CallTxOptions<C, PCK>): Promise<SubmittedCallTx<C, PCK>>;
...
declare function submitDeployTx<C extends Contract$1<undefined>>(providers: ContractProviders<C, Contract$1.ProvableCircuitId<C>, unknown>, options: DeployTxOptionsBase<C>): Promise<FinalizedDeployTxData<C>>;
...
contractAddress: ContractAddress$1, circuitId: Contract.ProvableCircuitId<C>, newVk: VerifierKey) => Promise<FinalizedTxData>;
...
contractAddress: ContractAddress$1, circuitId: Contract.ProvableCircuitId<C>) => Promise<FinalizedTxData>;
