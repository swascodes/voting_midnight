...
export type SubmitCallTxProviders<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>> = ContractProviders<C> | SubmitTxProviders<C, PCK>;
export declare function submitCallTx<C extends Contract<undefined>, PCK extends Contract.ProvableCircuitId<C>>(providers: SubmitTxProviders<C, PCK>, options: CallTxOptionsBase<C, PCK>): Promise<FinalizedCallTxData<C, PCK>>;
export declare function submitCallTx<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>>(providers: ContractProviders<C>, options: CallTxOptionsWithPrivateStateId<C, PCK>): Promise<FinalizedCallTxData<C, PCK>>;
export declare function submitCallTx<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>>(providers: ContractProviders<C>, options: CallTxOptionsWithPrivateStateId<C, PCK>, transactionContext: TransactionContext<C, PCK>): Promise<CallResult<C, PCK>>;
export declare function submitCallTx<C extends Contract<undefined>, PCK extends Contract.ProvableCircuitId<C>>(providers: SubmitTxProviders<C, PCK>, options: CallTxOptionsBase<C, PCK>, transactionContext: TransactionContext<C, PCK>): Promise<CallResult<C, PCK>>;
/**
 ...
 * ```
 */
export declare function submitCallTxAsync<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>>(providers: SubmitCallTxProviders<C, PCK>, options: CallTxOptions<C, PCK>): Promise<SubmittedCallTx<C, PCK>>;
