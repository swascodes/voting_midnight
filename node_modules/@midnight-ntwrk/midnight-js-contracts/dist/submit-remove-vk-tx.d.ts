 ...
 */
export declare const submitRemoveVerifierKeyTx: <C extends Contract.Any>(providers: ContractProviders, compiledContract: CompiledContract.CompiledContract<C, any>, // eslint-disable-line @typescript-eslint/no-explicit-any
contractAddress: ContractAddress, circuitId: Contract.ProvableCircuitId<C>) => Promise<FinalizedTxData>;
