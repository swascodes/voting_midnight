 ...
 */
export declare const submitReplaceAuthorityTx: <C extends Contract.Any>(providers: ContractProviders, compiledContract: CompiledContract.CompiledContract<C, any>, // eslint-disable-line @typescript-eslint/no-explicit-any
contractAddress: ContractAddress) => (newAuthority: SigningKey) => Promise<FinalizedTxData>;
