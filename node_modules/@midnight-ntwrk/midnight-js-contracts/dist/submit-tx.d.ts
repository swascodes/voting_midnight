 ...
 */
export type SubmitTxProviders<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>> = Omit<ContractProviders<C, PCK>, 'privateStateProvider'>;
/**
 ...
 */
export declare const submitTx: <C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>>(providers: SubmitTxProviders<C, PCK>, options: SubmitTxOptions<PCK>) => Promise<FinalizedTxData>;
/**
 * Proves, balances, and submits an unproven deployment or call transaction using
 ...
 */
export declare const submitTxAsync: <C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C>>(providers: SubmitTxProviders<C, PCK>, options: SubmitTxOptions<PCK>) => Promise<string>;
