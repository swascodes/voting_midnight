 ...
 */
export interface TransactionContext<C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C> = Contract.ProvableCircuitId<C>> {
    readonly [TypeId]: TypeId;
    readonly [Internal.Submit]: () => Promise<FinalizedCallTxData<C, PCK>>;
    readonly [Internal.MergeUnsubmittedCallTxData]: (circuitId: PCK, callData: UnsubmittedCallTxData<C, PCK>, privateStateId?: PrivateStateId) => void;
    readonly [Internal.CacheStates]: (states: ContractStates<Contract.PrivateState<C>> | PublicContractStates, identity: Internal.CachedStateIdentity) => void;
    readonly [Internal.GetCurrentStatesForIdentity]: (identity: Internal.CachedStateIdentity) => ContractStates<Contract.PrivateState<C>> | PublicContractStates | undefined;
    /**
 ...
 */
export declare const isTransactionContext: (u: unknown) => u is TransactionContext<Contract.Any>;
/**
 ...
 */
export declare const withContractScopedTransaction: <C extends Contract.Any, PCK extends Contract.ProvableCircuitId<C> = Contract.ProvableCircuitId<C>>(providers: ContractProviders<C, PCK>, fn: (txCtx: TransactionContext<C, PCK>) => Promise<void>, options?: ScopedTransactionOptions) => Promise<FinalizedCallTxData<C, PCK>>;
