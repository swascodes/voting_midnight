...
export declare function createUnprovenDeployTxFromVerifierKeys<C extends Contract<undefined>>(zkConfigProvider: ZKConfigProvider<string>, coinPublicKey: CoinPublicKey, options: DeployTxOptionsBase<C>, encryptionPublicKey: EncPublicKey): Promise<UnsubmittedDeployTxData<C>>;
export declare function createUnprovenDeployTxFromVerifierKeys<C extends Contract.Any>(zkConfigProvider: ZKConfigProvider<string>, coinPublicKey: CoinPublicKey, options: DeployTxOptionsWithPrivateState<C>, encryptionPublicKey: EncPublicKey): Promise<UnsubmittedDeployTxData<C>>;
/**
 * Providers needed to create an unproven deployment transactions, just the ZK artifact
 * provider and a wallet.
 */
export type UnprovenDeployTxProviders<C extends Contract.Any> = Pick<ContractProviders<C>, 'zkConfigProvider' | 'walletProvider'>;
...
export declare function createUnprovenDeployTx<C extends Contract.Any>(providers: UnprovenDeployTxProviders<C>, options: DeployTxOptionsWithPrivateState<C>): Promise<UnsubmittedDeployTxData<C>>;
