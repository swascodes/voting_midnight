...
<head>
    <title>Code coverage report for storage-encryption.ts</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
    <div class='pad1'>
        <h1><a href="index.html">All files</a> storage-encryption.ts</h1>
        <div class='clearfix'>
            
            <div class='fl pad1y space-right2'>
                <span class="strong">88.96% </span>
                <span class="quiet">Statements</span>
                <span class='fraction'>137/154</span>
            </div>
            ...
            <div class='fl pad1y space-right2'>
                ...
                <span class='fraction'>130/146</span>
            </div>
...
<a name='L334'></a><a href='#L334'>334</a></td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-yes">493x</span>
<span class="cline-any cline-yes">8802x</span>
<span class="cline-any cline-yes">501x</span>
<span class="cline-any cline-yes">501x</span>
<span class="cline-any cline-yes">2x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">8301x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">491x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">487x</span>
<span class="cline-any cline-yes">7745x</span>
<span class="cline-any cline-yes">7745x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">7745x</span>
<span class="cline-any cline-yes">23235x</span>
<span class="cline-any cline-yes">23235x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">23235x</span>
<span class="cline-any cline-yes">2515x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">20720x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">23235x</span>
<span class="cline-any cline-yes">39x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">23196x</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-yes">23235x</span>
...
&nbsp;
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (version !== ENCRYPTION_VERSION_V1 &amp;&amp; version !== ENCRYPTION_VERSION_V2) {
<span class="cstat-no" title="statement not covered" >    throw new Error(`Unsupported encryption version: ${version}`);</span>
  }
&nbsp;
  return {
    version,
...
&nbsp;
const <span class="fstat-no" title="function not covered" >constantTimeBufferEqual = (a</span>Buf: Buffer, bBuf: Buffer): boolean =&gt; {
<span class="cstat-no" title="statement not covered" >  if (aBuf.length !== bBuf.length) {</span>
<span class="cstat-no" title="statement not covered" >    throw new RangeError('Input buffers must have the same byte length');</span>
  }
  let result = <span class="cstat-no" title="statement not covered" >0;</span>
<span class="cstat-no" title="statement not covered" >  for (let i = <span class="cstat-no" title="statement not covered" >0; i</span> &lt; aBuf.length; i++) {</span>
<span class="cstat-no" title="statement not covered" >    result |= aBuf[i] ^ bBuf[i];</span>
  }
...
export const timingSafeEqual = (a: Buffer | Uint8Array, b: Buffer | Uint8Array): boolean =&gt; {
  ...
  <span class="missing-if-branch" title="else path not taken" >E</span>if (HAS_NATIVE_TIMINGSAFEEQUAL) {
    // Use the native `timingSafeEqual` function and let any errors propagate.
    return crypto.timingSafeEqual(aBuf, bBuf);
  }
<span class="cstat-no" title="statement not covered" >  return constantTimeBufferEqual(aBuf, bBuf);</span>
};
&nbsp;
&nbsp;
...
&nbsp;
    <span class="missing-if-branch" title="if path not taken" >I</span>if (!this.salt.equals(salt)) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Salt mismatch: data was encrypted with a different password');</span>
    }
&nbsp;
...
&nbsp;
  static getVersion(encryptedData: string): number {
    ...
    <span class="missing-if-branch" title="if path not taken" >I</span>if (buffer.length &lt; 1) {
<span class="cstat-no" title="statement not covered" >      throw new Error('Invalid encrypted data: too short');</span>
    }
    return buffer[0];
  }
&nbsp;
...
export const decryptValue = (
  ...
  <span class="missing-if-branch" title="if path not taken" >I</span>if (!StorageEncryption.isEncrypted(encryptedValue)) {
<span class="cstat-no" title="statement not covered" >    console.debug('MIDNIGHT: Encountered unencrypted data during decryption - passing through as-is');</span>
<span class="cstat-no" title="statement not covered" >    return encryptedValue;</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >    return encryption.decryptWithPassword(encryptedValue, password);</span>
  }
