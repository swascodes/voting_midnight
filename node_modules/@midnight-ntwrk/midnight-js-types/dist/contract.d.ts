import { type ContractExecutable } from '@midnight-ntwrk/compact-js/effect';
 ...
 */
export declare const makeContractExecutableRuntime: (zkConfigProvider: ZKConfigProvider<string>, options: ContractExecutableRuntimeOptions) => ManagedRuntime<ContractExecutable.ContractExecutable.Context, ConfigError.ConfigError>;
/**
 ...
 */
export declare const exitResultOrError: <A, E>(exit: Exit.Exit<A, E>) => A;
/**
 ...
 */
export declare const asEffectOption: <T>(obj: unknown) => Option.Option<T>;
/**
 ...
 */
export declare const asContractAddress: (address: string) => ContractAddress.ContractAddress;
