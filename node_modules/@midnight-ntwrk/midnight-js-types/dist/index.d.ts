...
import { Transaction, SignatureEnabled, Proof, Binding, TransactionId, TransactionHash, ContractAddress, IntentHash, RawTokenType, FinalizedTransaction, UnprovenTransaction, PreBinding, ProvingProvider, CostModel, ZswapChainState, LedgerParameters, CoinPublicKey, EncPublicKey } from '@midnight-ntwrk/ledger-v8';
...
type AnyPrivateState = Contract.PrivateState<Contract.Any>;
/**
 ...
 * This limit prevents memory exhaustion attacks.
 */
declare const MAX_EXPORT_SIGNING_KEYS = 10000;
/**
 ...
 */
declare const createProofProvider: (provingProvider: ProvingProvider, costModel?: CostModel) => ProofProvider;
...
interface PublicDataProvider {
     ...
     *               If `undefined` returns the latest states.
     */
    queryZSwapAndContractState(contractAddress: ContractAddress, config?: BlockHeightConfig | BlockHashConfig): Promise<[ZswapChainState, ContractState, LedgerParameters] | null>;
    /**
 ...
 * @typeParam PS - Parameter indicating the private state type stored, sometimes a union of private state types.
 */
interface MidnightProviders<PCK extends AnyProvableCircuitId = AnyProvableCircuitId, PSI extends PrivateStateId = PrivateStateId, PS = any> {
    /**
