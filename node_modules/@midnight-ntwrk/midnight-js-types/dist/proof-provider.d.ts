import { CostModel, type PreBinding, type Proof, type ProvingProvider, type SignatureEnabled, type Transaction, type UnprovenTransaction } from '@midnight-ntwrk/ledger-v8';
 ...
 */
export declare const createProofProvider: (provingProvider: ProvingProvider, costModel?: CostModel) => ProofProvider;
