 ...
 * limitations under the License.
 */
const ttlOneHour = () => new Date(Date.now() + 60 * 60 * 1000);
 ...
 */
const fromHex = (str) => buffer.Buffer.from(str, 'hex');
/**
...
const parseCoinPublicKeyToHex = (possibleBech32, zswapNetworkId) => {
    ...
    return buffer.Buffer.from(decoded.data).toString('hex');
};
/**
