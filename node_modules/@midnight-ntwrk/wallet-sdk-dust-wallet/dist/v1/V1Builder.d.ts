...
import { type VariantBuilder, type Variant } from '@midnight-ntwrk/wallet-sdk-runtime/abstractions';
import { type WalletError } from './WalletError.js';
import { type SyncService, type SyncCapability, type DefaultSyncConfiguration, type WalletSyncUpdate } from './Sync.js';
...
declare namespace V1Builder {
     ...
     */
    type FullBuildState<TConfig, TContext, TSerialized, TSyncUpdate, TTransaction, TStartAux> = Types.Simplify<HasSync<TConfig, TContext, TSyncUpdate, TStartAux> & HasSerialization<TConfig, TContext, TSerialized> & HasTransacting<TConfig, TContext, TTransaction> & HasCoinSelection<TConfig, TContext> & HasCoinsAndBalances<TConfig, TContext> & HasKeys<TConfig, TContext>>;
